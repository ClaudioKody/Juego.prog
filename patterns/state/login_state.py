...
class LoginState(GameState):
    ...
    def procesar_ingreso(self):
        ...
        try:
            ...
            if self.modo == "REGISTRAR":
                ...
                print("REGISTRO: buscando o creando usuario...")

                level, max_score = user_repo.obtener_o_crear_usuario(
                    self.username
                )
                ...
                print(
                    f"Usuario '{self.username}' registrado correctamente."
                )
            ...
            # ==========================================
                ...
                if resultado is None:
                    ...
                    print(
                        f"LOGIN RECHAZADO: '{self.username}' "
                        "no esta registrado."
                    )
                ...
                print(
                    f"LOGIN CORRECTO: usuario '{self.username}'."
                )
    ...
    def draw(self, screen):
        ...
        if self.modo == "MENU":
            ...
            text_reg = self.font_text.render(
                "Registrarse",
                True,
                self.color_text
            )
            ...
            text_ini = self.font_text.render(
                "Iniciar Sesión",
                True,
                self.color_text
            )
        ...
        # ==========================================
            ...
            if self.modo == "REGISTRAR":
                titulo_modo = "REGISTRO DE NUEVO USUARIO"
            else:
                titulo_modo = "INICIAR SESIÓN"
            ...
            instruction = self.font_small.render(
                "Escribí tu nombre de usuario y presioná ENTER:",
                True,
                (200, 200, 200)
            )
            ...
            txt_surface = self.font_text.render(
                self.username,
                True,
                self.color_text
            )
            ...
            txt_volver = self.font_small.render(
                "Volver",
                True,
                self.color_text
            )
